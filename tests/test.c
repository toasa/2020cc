...
int main() {
    ...
    test(1, ({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+0); }), "({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+0); })");
    test(0, ({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+1); }), "({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+1); })");
    test(3, ({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+2); }), "({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+2); })");
    test(4, ({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+3); }), "({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+3); })");
    test(0, ({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+4); }), "({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+4); })");
    test(0, ({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+5); }), "({ int x[3][2]={{1},{3,4}}; int *p=x; *(p+5); })");

    test(0, ({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+0); }), "({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+0); })");
    test(0, ({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+1); }), "({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+1); })");
    test(1, ({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+2); }), "({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+2); })");
    test(0, ({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+3); }), "({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+3); })");
    test(3, ({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+4); }), "({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+4); })");
    test(4, ({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+5); }), "({ int x[3][2]={{},{1},{3,4}}; int *p=x; *(p+5); })");

    test(1, ({ int arr[3]={1,2,3,}; arr[0]; }), "({ int arr[3]={1,2,3,}; arr[0]; })");
    test(0, ({ int arr[3]={1,2,}; arr[2]; }), "({ int arr[3]={1,2,}; arr[2]; })");
